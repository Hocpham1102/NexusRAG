...
def _ollama_error_message(error: Exception) -> str:
    message = str(error)
    if "ConnectError" in error.__class__.__name__ or "All connection attempts failed" in message:
        return (
            "Ollama is not reachable at the configured host. "
            "Start Ollama or check OLLAMA_HOST, then try again."
        )
    ...
    def complete(
        ...
        *,
        ...
        try:
            ...
            return _ollama_error_message(e)
    ...
    async def astream(
        ...
        *,
        ...
        try:
            ...
            yield StreamChunk(type="text", text=_ollama_error_message(e))
